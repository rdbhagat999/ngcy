          ...
          <div class="flex flex-row justify-start items-center flex-wrap -mx-3">
            <div class="flex-none w-auto max-w-full px-3">
              <div
                ...
                <img
                  [src]="
                    (profile$ | async)?.image || '/assets/profile_user.jpg'
                  "
                  alt="profile_image"
              ...
              <div
                ...
                <div class="flex-auto p-4">
                  <p class="leading-normal text-size-sm">
                    Hi, I’m {{ (profile$ | async)?.firstName }}
                    {{ (profile$ | async)?.lastName }}, Decisions: If you can’t
                  ...
                  <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                    ...
                    <li
                      ...
                      {{ (profile$ | async)?.address?.city }},
                      {{ (profile$ | async)?.address?.state }},
                      {{ (profile$ | async)?.address?.postalCode }}
                    </li>
                    <!-- <li
